    ...
    <div className="w-full flex flex-col sm:px-4 bg-[#101a23] border-b-4 border-[#2f9fff]">
      ...
      <div>
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-8 py-2 text-white rounded-xl text-[18px]">
          ...
          <div className="flex items-center gap-4 px-4 py-2 text-white rounded-xl">
            Support
            <a
              href="#"
              target="_blank"
              rel="noreferrer"
              className="border-2 border-[#f5f5f5] rounded-lg p-1 px-[10px]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="32"
                height="32"
                fill="currentColor"
                className="bi bi-twitter-x w-[20px]"
                viewBox="0 0 16 16"
              >
            ...
            >
              <svg
                ...
                height="32"
                fill="currentColor"
                className="bi bi-telegram w-[24px]"
                viewBox="0 0 16 16"
              >
            ...
            >
              <svg
                ...
                height="36"
                fill="currentColor"
                className="bi bi-discord w-[24px]"
                viewBox="0 0 16 16"
              >
